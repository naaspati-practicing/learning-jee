...
public class MainTest {
    ...
    private static final String TRUSTORE_CLIENT_FILE = "./creds/truststore_client";
    private static final String TRUSTSTORE_CLIENT_PWD = "asdfgh";
    private static final String KEYSTORE_CLIENT_FILE = "./creds/keystore_client";
    ...
    public void setUp() throws Exception {
        synchronized (serverGuard) {
            if (server != null) {
                throw new IllegalStateException("Test run sync issue: Another instance of the SSL-secured HTTP test server has been already started.");
            }
            server = new Server(true);
            LOGGER.info("server started: "+App.BASE_URI);
        }
    }
    ...
    public void tearDown() throws Exception {
        synchronized (serverGuard) {
            ...
            server.shutdownNow();
            LOGGER.info("server shutdown: "+App.BASE_URI);
            server = null;
        }
    }
    ...
    private void _testSSLWithBasicAndSSLAuth(ClientConfig clientConfig) {
        ...
        LOGGER.info("Client: GET " + App.BASE_URI);
